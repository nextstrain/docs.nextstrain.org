...
of pathogen genome data.  It's made up of many different parts that all work
...
Our intent for this documentation site is to cover all parts of Nextstrain,
from viewing the website to producing your own analyses to contributing to
Nextstrain's development.

.. hint::

    If you're new to Nextstrain, start with :doc:`/learn/about`.

    If you're interested in how to interpret what you see on nextstrain.org, start
    with :doc:`/learn/interpret/index`.

    If you're ready to go beyond viewing the website (or just plain curious!),
    start with :doc:`/learn/parts`.
...
.. toctree::
    ...
    Viewing previous analyses <guides/versions>
