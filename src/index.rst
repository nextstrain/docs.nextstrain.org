...
This documentation is structured to meet the needs of the following user personas
- Bioinformatician
- Researcher
...
- Software developer
- GISAID User
(TODO insert links to detailed descriptions of those if it seems useful) and is comprised of four different types of documents:
- Tutorials
- How-to guides
- Reference guides
- Explanations (also known as Discussions)
(TODO link to more on documentation system and why it's good)
...
- I have submitted sequences to GISAID or GenBank and want to see if they’ve been included in a Nextstrain-maintained build!
